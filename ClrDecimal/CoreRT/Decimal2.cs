...
namespace CoreRT
{
    ...
    unsafe public partial struct Decimal2 : IFormattable, IComparable, IConvertible, IComparable<Decimal2>, IEquatable<Decimal2>, IDeserializationCallback
    {
        ...
        public static readonly Decimal2 Zero = 0m;

        // Constant representing the Decimal value 1.
        public static readonly Decimal2 One = 1m;

        // Constant representing the Decimal value -1.
        public static readonly Decimal2 MinusOne = -1m;
        ...
        public static readonly Decimal2 MaxValue = 79228162514264337593543950335m;

        // Constant representing the smallest possible Decimal value. The value of
        // this constant is -79,228,162,514,264,337,593,543,950,335.
        public static readonly Decimal2 MinValue = -79228162514264337593543950335m;
        ...
        public static Decimal2 FromOACurrency(long cy)
        {
            Decimal2 d = default(Decimal2);
        ...
        public static long ToOACurrency(Decimal2 value)
        {
            long cy;
        ...
        // is -d.
        //
        internal static Decimal2 Abs(Decimal2 d)
        {
            return new Decimal2(d.lo, d.mid, d.hi, (int)(d.uflags & ~SignMask));
        }


        // Adds two Decimal values.
        //
        public static Decimal2 Add(Decimal2 d1, Decimal2 d2)
        {
        ...
        public static Decimal2 Ceiling(Decimal2 d)
        {
            return (-(Decimal2.Floor(-d)));
        }

        // Compares two Decimal values, returning an integer that indicates their
        // relationship.
        //
        public static int Compare(Decimal2 d1, Decimal2 d2)
        {
        ...
        //
        public static Decimal2 Divide(Decimal2 d1, Decimal2 d2)
        {
        ...
        public bool Equals(Decimal2 value)
        {
        ...
        //
        public static bool Equals(Decimal2 d1, Decimal2 d2)
        {
        ...
        //
        public static Decimal2 Floor(Decimal2 d)
        {
        ...
        //
        public static Decimal2 Parse(String s)
        {
        ...
        public static Decimal2 Parse(String s, NumberStyles style)
        {
            ValidateParseStyleFloatingPoint(style);
            return FormatProvider.ParseDecimal2(s, style, null);
        }

        public static Decimal2 Parse(String s, IFormatProvider provider)
        {
            return FormatProvider.ParseDecimal2(s, NumberStyles.Number, provider);
        }

        public static Decimal2 Parse(String s, NumberStyles style, IFormatProvider provider)
        {
            ValidateParseStyleFloatingPoint(style);
            return FormatProvider.ParseDecimal2(s, style, provider);
        }

        public static Boolean TryParse(String s, out Decimal2 result)
        {
            return FormatProvider.TryParseDecimal2(s, NumberStyles.Number, null, out result);
        }

        public static Boolean TryParse(String s, NumberStyles style, IFormatProvider provider, out Decimal2 result)
        {
            ValidateParseStyleFloatingPoint(style);
            return FormatProvider.TryParseDecimal2(s, style, provider, out result);
        }
        ...
        // meaning negative.
        //
        public static int[] GetBits(Decimal2 d)
        {
            return new int[] { d.lo, d.mid, d.hi, d.flags };
        }

        internal static void GetBytes(Decimal2 d, byte[] buffer)
        {
        ...
        //
        internal static Decimal2 Max(Decimal2 d1, Decimal2 d2)
        {
        ...
        //
        internal static Decimal2 Min(Decimal2 d1, Decimal2 d2)
        {
            return Compare(d1, d2) < 0 ? d1 : d2;
        }


        public static Decimal2 Remainder(Decimal2 d1, Decimal2 d2)
        {
        ...
        //
        public static Decimal2 Multiply(Decimal2 d1, Decimal2 d2)
        {
            Decimal2 decRes;
        ...
        //
        public static Decimal2 Negate(Decimal2 d)
        {
            return new Decimal2(d.lo, d.mid, d.hi, (int)(d.uflags ^ SignMask));
        }
        ...
        public static Decimal2 Round(Decimal2 d)
        {
            return Round(d, 0);
        }

        public static Decimal2 Round(Decimal2 d, int decimals)
        {
            Decimal2 result = new Decimal2();
        ...
        public static Decimal2 Round(Decimal2 d, int decimals, MidpointRounding mode)
        {
            if (decimals < 0 || decimals > 28)
                throw new ArgumentOutOfRangeException(nameof(decimals), SR.ArgumentOutOfRange_DecimalRound);
        ...
        //
        public static Decimal2 Subtract(Decimal2 d1, Decimal2 d2)
        {
        ...
        //
        public static byte ToByte(Decimal2 value)
        {
            uint temp;
            try
            {
        ...
        //
        [CLSCompliant(false)]
        public static sbyte ToSByte(Decimal2 value)
        {
            int temp;
            try
            {
        ...
        //
        public static short ToInt16(Decimal2 value)
        {
            int temp;
            try
            {
        ...
        //
        public static double ToDouble(Decimal2 d)
        {
        ...
        //
        public static int ToInt32(Decimal2 d)
        {
        ...
        // returned as a long.
        //
        public static long ToInt64(Decimal2 d)
        {
            if (d.Scale != 0) DecCalc.VarDecFix(ref d);
            if (d.uhi == 0)
            {
        ...
        //
        [CLSCompliant(false)]
        public static ushort ToUInt16(Decimal2 value)
        {
            uint temp;
            try
            {
        ...
        //
        [CLSCompliant(false)]
        public static uint ToUInt32(Decimal2 d)
        {
            if (d.Scale != 0) DecCalc.VarDecFix(ref d);
            if (d.uhi == 0 && d.umid == 0)
            {
        ...
        //
        [CLSCompliant(false)]
        public static ulong ToUInt64(Decimal2 d)
        {
            if (d.Scale != 0) DecCalc.VarDecFix(ref d);
            if (d.uhi == 0)
            {
        ...
        // digits than a Decimal, this operation may produce round-off errors.
        //
        public static float ToSingle(Decimal2 d)
        {
        ...
        //
        public static Decimal2 Truncate(Decimal2 d)
        {
...
#endif
        public static implicit operator Decimal2(System.Decimal value)
        {
            return new Decimal2(value);
        }

        public static implicit operator System.Decimal(Decimal2 value)
        {
            return new decimal(Decimal2.GetBits(value));
        }

        [CLSCompliant(false)]
        public static explicit operator ushort(Decimal2 value)
        {
            return ToUInt16(value);
        }

        public static explicit operator int(Decimal2 value)
        {
            return ToInt32(value);
        }

        [CLSCompliant(false)]
        public static explicit operator uint(Decimal2 value)
        {
            return ToUInt32(value);
        }

        public static explicit operator long(Decimal2 value)
        {
            return ToInt64(value);
        }

        [CLSCompliant(false)]
        public static explicit operator ulong(Decimal2 value)
        {
            return ToUInt64(value);
        }

        public static explicit operator float(Decimal2 value)
        {
            return ToSingle(value);
        }

        public static explicit operator double(Decimal2 value)
        {
            return ToDouble(value);
        }

        public static Decimal2 operator +(Decimal2 d)
        {
            return d;
        }
        ...
        public static Decimal2 operator +(Decimal2 d1, Decimal2 d2)
        {
            return Add(d1, d2);
        }
        ...
        public static bool operator ==(Decimal2 d1, Decimal2 d2)
        {
            return DecCalc.VarDecCmp(ref d1, ref d2) == 0;
        }
        ...
        System.Decimal IConvertible.ToDecimal(IFormatProvider provider)
        {
            return this;
        }
