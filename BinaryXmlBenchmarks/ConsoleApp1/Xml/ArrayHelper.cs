...
namespace System.Xml
{
    internal abstract class ArrayHelper<TArgument, TArray>
    {
        ...
        public void WriteArray(XmlDictionaryWriter2 writer, string prefix, TArgument localName, TArgument namespaceUri, XmlDictionaryReader reader)
        {
            int count;
            if (reader.TryGetArrayLength(out count))
        ...
        protected abstract void WriteArray(XmlDictionaryWriter2 writer, string prefix, TArgument localName, TArgument namespaceUri, TArray[] array, int offset, int count);
    }
    ...
    internal sealed class BooleanArrayHelperWithString : ArrayHelper<string, bool>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, bool[] array, int offset, int count)
        {
    ...
    internal sealed class BooleanArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, bool>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, bool[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class Int16ArrayHelperWithString : ArrayHelper<string, short>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, short[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class Int16ArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, short>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, short[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class Int32ArrayHelperWithString : ArrayHelper<string, int>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, int[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class Int32ArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, int>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, int[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class Int64ArrayHelperWithString : ArrayHelper<string, long>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, long[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class Int64ArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, long>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, long[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class SingleArrayHelperWithString : ArrayHelper<string, float>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, float[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class SingleArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, float>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, float[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class DoubleArrayHelperWithString : ArrayHelper<string, double>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, double[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class DoubleArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, double>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, double[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class DecimalArrayHelperWithString : ArrayHelper<string, decimal>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, decimal[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class DecimalArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, decimal>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, decimal[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class DateTimeArrayHelperWithString : ArrayHelper<string, DateTime>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, DateTime[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class DateTimeArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, DateTime>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, DateTime[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class GuidArrayHelperWithString : ArrayHelper<string, Guid>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, Guid[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class GuidArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, Guid>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, Guid[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class TimeSpanArrayHelperWithString : ArrayHelper<string, TimeSpan>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, string localName, string namespaceUri, TimeSpan[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
    ...
    internal sealed class TimeSpanArrayHelperWithDictionaryString : ArrayHelper<XmlDictionaryString, TimeSpan>
    {
        ...
        protected override void WriteArray(XmlDictionaryWriter2 writer, string prefix, XmlDictionaryString localName, XmlDictionaryString namespaceUri, TimeSpan[] array, int offset, int count)
        {
            writer.WriteArray(prefix, localName, namespaceUri, array, offset, count);
        }
    }
