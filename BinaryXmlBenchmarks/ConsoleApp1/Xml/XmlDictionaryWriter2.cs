...
{
    public abstract class XmlDictionaryWriter2 : XmlWriter
    {
        public static XmlDictionaryWriter2 CreateBinaryWriter(Stream stream)
        {
            return CreateBinaryWriter(stream, null);
        }

        public static XmlDictionaryWriter2 CreateBinaryWriter(Stream stream, IXmlDictionary? dictionary)
        {
            return CreateBinaryWriter(stream, dictionary, null);
        }

        public static XmlDictionaryWriter2 CreateBinaryWriter(Stream stream, IXmlDictionary? dictionary, XmlBinaryWriterSession? session)
        {
            return CreateBinaryWriter(stream, dictionary, session, true);
        }

        public static XmlDictionaryWriter2 CreateBinaryWriter(Stream stream, IXmlDictionary? dictionary, XmlBinaryWriterSession? session, bool ownsStream)
        {
        ...
        public static XmlDictionaryWriter2 CreateTextWriter(Stream stream)
        {
            return CreateTextWriter(stream, s_UTF8Encoding, true);
        }

        public static XmlDictionaryWriter2 CreateTextWriter(Stream stream, Encoding encoding)
        {
            return CreateTextWriter(stream, encoding, true);
        }

        public static XmlDictionaryWriter2 CreateTextWriter(Stream stream, Encoding encoding, bool ownsStream)
        {
        ...
        public static XmlDictionaryWriter2 CreateMtomWriter(Stream stream, Encoding encoding, int maxSizeInBytes, string startInfo)
        {
            return CreateMtomWriter(stream, encoding, maxSizeInBytes, startInfo, null, null, true, true);
        }

        public static XmlDictionaryWriter2 CreateMtomWriter(Stream stream, Encoding encoding, int maxSizeInBytes, string startInfo, string? boundary, string? startUri, bool writeMessageHeaders, bool ownsStream)
        {
            throw new PlatformNotSupportedException(SR.PlatformNotSupported_MtomEncoding);
        }

        public static XmlDictionaryWriter2 CreateDictionaryWriter(XmlWriter writer)
        {
            ArgumentNullException.ThrowIfNull(writer);

            XmlDictionaryWriter2? dictionaryWriter = writer as XmlDictionaryWriter2;
...
#pragma warning suppress 56506 // Microsoft, XmlDictionaryString.Empty is never null
        ...
        private sealed class XmlWrappedWriter : XmlDictionaryWriter2
        {
