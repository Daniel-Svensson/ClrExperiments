...
namespace ConsoleApp1
{
	public partial class AsciiBenchmarks
	{
		...
		//[Params(16, 20, 25, 32)]
		[Params(33, 36, 39, 41, 44, 48, 51, 52, 55, 58, 63, 64, 72, 80, 88, 96, 104)]
		...
		public unsafe nuint Ascii_Local_NarrowUtf16ToAscii_simple_loop()
		{
			fixed (char* s = _input)
			fixed (byte* _bytes = _buffer)
				return Test.Ascii.NarrowUtf16ToAscii_simple(s, _bytes, (uint)Math.Min(_input.Length, _buffer.Length));
		}
